...
def run_initialization_experiments():
    ...
    strategies = [
        ...
        {'init': 'normal', 'gain': 0.01, 'lr': 0.001, 'name': 'Too Small Init'},
        
        # Strategy that should lead to effective learning
        {'init': 'kaiming_normal', 'gain': 1.0, 'lr': 0.001, 'name': 'Effective Init'},
        
        # Strategy that should lead to unstable learning
        {'init': 'normal', 'gain': 10.0, 'lr': 0.001, 'name': 'Too Large Init'}
    ]
